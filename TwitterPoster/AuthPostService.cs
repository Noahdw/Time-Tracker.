...
namespace TwitterPoster
{
    class AuthPostService
    {
        ...
        {
            string path = Path.Combine(Environment.CurrentDirectory, @"Data\", "Tokens.txt");
            string[] tokenLines = File.ReadAllLines(@"C:\Users\Puter\Desktop\SleepTracker\Tokens.txt");
